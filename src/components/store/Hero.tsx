...
function Hero({}: Props) {
  return (
    <Fade>
    <Box w="100vw" backgroundImage={`${SERVER_HOST}/uploads/large_pexels_archie_binamira_708798_92bc86bb21.jpg`} backgroundPosition="center" backgroundRepeat="no-repeat" backgroundSize="cover" mt={-24}>
      <Box w="100vw" bg="gray.700" opacity={.7  }>
      <Stack
        as={Box}
      ...
      >
        <Stack as={Box} spacing={4} w={{ base: "full", md: "40%" }}>
          <Fade delay={1000}>
          <Slide delay={500}  cascade damping={.75}>
          <Heading 
            fontWeight={700} 
            as="h2"
          >
